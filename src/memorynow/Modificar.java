    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Enviar")) {
            ...
            if (true) {
                ...
                //Para seleccionar solo un radio boton
                /* if (_SexoM.isSelected() == true) {
                 _SexoF.setSelected(false);
                 } else {
                 if (_SexoF.isSelected() == true) {
                 _SexoM.setSelected(false);
                 }
                 }*/
            } else {
