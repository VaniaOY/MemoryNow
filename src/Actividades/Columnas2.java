...
public class Columnas2 extends JFrame implements ActionListener {
    ...
    public void verColumnas() {
        ...
        foto = new JLabel();
        foto.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza1.jpg")));
        ...
        foto.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getSource() == foto) {
                    ...
                    fotoo = new JLabel();
                    fotoo.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza1.1.jpg")));
        ...
        foto2 = new JLabel();
        foto2.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza2.jpg")));
        ...
        foto2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getSource() == foto2) {
                    ...
                    fotoo2 = new JLabel();
                    fotoo2.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza2.2.jpg")));
        ...
        foto3 = new JLabel();
        foto3.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza3.jpg")));
        ...
        foto3.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getSource() == foto3){
                    ...
                    fotoo3 = new JLabel();
                    fotoo3.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/taza3.3.jpg")));
        ...
        foto4 = new JLabel();
        foto4.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/plato1.jpg")));
        foto4.setBounds(800, 50, 200, 200);
        Fondo.add(foto4);

        foto5 = new JLabel();
        foto5.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/plato3.png")));
        foto5.setBounds(800, 250, 200, 200);
        Fondo.add(foto5);

        foto6 = new JLabel();
        foto6.setIcon(new ImageIcon(getClass().getResource("/IMAGENES/plato2.jpg")));
